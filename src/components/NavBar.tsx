...
export type NavBarType = {
  /** Style props */
  navItemsDebugCommit?: CSSProperties;
  navItemsBackgroundColor?: CSSProperties["backgroundColor"];
};

const NavBar: FunctionComponent<NavBarType> = ({
  navItemsDebugCommit,
  navItemsBackgroundColor,
}) => {
  const navBarStyle: CSSProperties = useMemo(() => {
    return {
      debugCommit: navItemsDebugCommit,
      backgroundColor: navItemsBackgroundColor,
    };
  }, [navItemsDebugCommit, navItemsBackgroundColor]);
