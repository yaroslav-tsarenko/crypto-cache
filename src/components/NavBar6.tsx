...
import styles from "./NavBar6.module.css";

export type NavBar6Type = {
  /** Style props */
  frameDivTop?: CSSProperties["top"];
  frameDivPosition?: CSSProperties["position"];
};

const NavBar6: FunctionComponent<NavBar6Type> = ({
  frameDivTop,
  frameDivPosition,
}) => {
  ...
  return (
    <header className={styles.navBar} style={navBar1Style}>
